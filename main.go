...
func showConfig(console *Console) {
	...
	console.Println(white(fmt.Sprintf("  Plancke Stats:   %s", boolStr(cfg.HypixelPlanckeStats))))
	console.Println(white(fmt.Sprintf("  Optifine Cape:   %s", boolStr(cfg.OptifineCape))))
	console.Println(white(fmt.Sprintf("  MC Capes:        %s", boolStr(cfg.MinecraftCapes))))
	console.Println(white(fmt.Sprintf("  Email Access:    %s", boolStr(cfg.EmailAccess))))
	console.Println(white(fmt.Sprintf("  Namechange:      %s", boolStr(cfg.NamechangeCheck))))
	console.Println(white(fmt.Sprintf("  Donut SMP Stats: %s", boolStr(cfg.DonutSMPStats))))
